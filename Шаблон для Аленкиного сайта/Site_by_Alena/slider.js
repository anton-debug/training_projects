			...
			if (!this.r) {
				if (m) {
					if (p == -1 || (p != 0 && Math.abs(p) % this.l == 0)) {
						...
						this.v
							? (this.u.style.height = this.l * this.h * this.b + 'px')
							: (this.u.style.width = this.l * this.w * this.b + 'px');
					}
					if (p == -1 || (p < 0 && Math.abs(p) % this.l == 0)) {
						this.v
							? (this.u.style.top = this.l * this.h * -1 + 'px')
							: (this.u.style.left = this.l * this.w * -1 + 'px');
						v = this.l - 1;
					}
